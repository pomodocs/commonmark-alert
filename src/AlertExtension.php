...
final class AlertExtension implements ConfigurableExtensionInterface
{
    ...
    public function configureSchema(ConfigurationBuilderInterface $builder): void
    {
        $builder->addSchema('alert', Expect::structure([
            ...
            'strong_title' => Expect::bool(true),
            'icons' => Expect::bool(false),
            'icon_names' => Expect::structure([
                'note' => Expect::string('info'),
                'tip' => Expect::string('light-bulb'),
                'important' => Expect::string('report'),
                'warning' => Expect::string('alert'),
                'caution' => Expect::string('stop'),
            ]),
            'icon_svg' => Expect::structure([
